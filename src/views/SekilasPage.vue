      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
          <div class="w-full lg:w-1/2 relative">
            <img src="https://images.unsplash.com/photo-1523050853063-bd80e292472d?auto=format&fit=crop&q=80&w=1000"
              alt="Kyai" class="rounded-2xl shadow-xl relative z-10 border-4 border-white w-full">
            <div
          ...
          <div class="w-full lg:w-1/2">
            ...
            <p class="text-slate-600 text-sm md:text-base mb-6 leading-relaxed">
              Didirikan sejak 1995, kami berkomitmen melahirkan kader pemimpin umat yang memiliki kedalaman spiritual
